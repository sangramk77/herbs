...
<head>
    ...
    <title>Welcome to Natural Rudraksh</title>
...
<body>
    <span class="preheader">
        Welcome to Natural Rudraksh. Explore authentic Rudraksha, guidance, and spiritual essentials.
    </span>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" class="container"
                    ...
                    <tr>
                        <td class="px" style="padding:10px 40px 6px 40px;">
                            <div
                                style="font-family:'Roboto Slab', Georgia, serif;font-size:30px;line-height:38px;font-weight:700;color:#7c2d12;text-align:center;">
                                Welcome,
                                <span style="color:#ea580c;">{{ $user->name ?? 'there' }}</span>.
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="px" style="padding:0 40px 20px 40px;">
                            <div
                                ...
                                Thank you for joining Natural Rudraksh. We are here to help you choose authentic
                                Rudraksha beads and spiritual essentials with confidence and clarity.
                            </div>
                        </td>
                    </tr>
                    ...
                    <!-- CTA -->
                    <tr>
                        <td class="px" align="center" style="padding:0 40px 28px 40px;">
                            ...
                            <div style="padding-top:10px;font-family:'Roboto', Arial, sans-serif;font-size:12px;line-height:18px;color:#9a3412;text-align:center;">
                                Tip: save this email for quick access to our store and support.
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="px" style="padding:0 40px 8px 40px;">
                            <div
                                style="font-family:'Roboto Slab', Georgia, serif;font-size:18px;line-height:26px;font-weight:700;color:#7c2d12;text-align:left;">
                                What you can expect
                            </div>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td class="stack" width="33.33%" valign="top"
                                        style="padding:14px 12px 0 0;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                            border="0" height="152"
                                            style="border:1px solid #fed7aa;border-radius:14px;background:#fff7ed;height:152px;">
                                            <tr>
                                                <td valign="top" height="152"
                                                    style="padding:14px 14px 12px 14px;height:152px;">
                                                    <div
                                                        style="font-family:'Roboto', Arial, sans-serif;font-size:14px;line-height:20px;font-weight:700;color:#9a3412;">
                                                        Authentic Products
                                                    </div>
                                                    <div
                                                        style="padding-top:6px;font-family:'Roboto', Arial, sans-serif;font-size:13px;line-height:20px;color:#431407;">
                                                        Carefully sourced and quality checked for trust and peace of
                                                        mind.
                                                    </div>
                                                </td>
                                            </tr>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td valign="top" height="152"
                                                    ...
                                                    <div
                                                        style="padding-top:6px;font-family:'Roboto', Arial, sans-serif;font-size:13px;line-height:20px;color:#431407;">
                                                        Simple product details to help you pick what fits your needs.
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td valign="top" height="152"
                                                    ...
                                                    <div
                                                        style="padding-top:6px;font-family:'Roboto', Arial, sans-serif;font-size:13px;line-height:20px;color:#431407;">
                                                        Reach us any time for order help or product questions.
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding-top:18px;">
                                        <div
                                            style="font-family:'Roboto', Arial, sans-serif;font-size:13px;line-height:20px;color:#431407;">
                                            Useful links:
                                            <a href="{{ url('/about') }}" style="color:#ea580c;text-decoration:underline;">About</a>
                                            &nbsp;|&nbsp;
                                            <a href="{{ route('contact.index') }}"
                                                style="color:#ea580c;text-decoration:underline;">Contact</a>
                                            &nbsp;|&nbsp;
                                            <a href="{{ route('product.index') }}"
                                                style="color:#ea580c;text-decoration:underline;">Shop</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td class="px" style="padding:10px 40px 28px 40px;">
                            <div
