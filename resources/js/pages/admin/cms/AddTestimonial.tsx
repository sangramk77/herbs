...
export default function AddTestimonial({ auth }: AddTestimonialProps) {
    ...
    const onSubmit = (data: FormValues) => {
        ...
        router.post('/admin/cms/testimonial', formData, {
            forceFormData: true,
            onSuccess: () => {
            ...
            onError: (errors) => {
                ...
                toast.error(
                    'Failed to create testimonial. Please check the form.',
                );
            },
            onFinish: () => {
