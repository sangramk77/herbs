...
type Tooltip = any
type TileLayer = any
type MapContainerProps = Record<string, any>
type TileLayerProps = Record<string, any>
type LayerGroupProps = Record<string, any>
type MarkerProps = Record<string, any>
type CircleProps = Record<string, any>
type CircleMarkerProps = Record<string, any>
type PolylineProps = Record<string, any>
type PolygonProps = Record<string, any>
type RectangleProps = Record<string, any>
...
function MapMarker({
    ...
    return (
        <LeafletMarker
            {...({
                icon: L.divIcon({
                    html: renderToString(icon as React.ReactElement),
                    iconAnchor,
                    ...(bgPos ? { bgPos } : {}),
